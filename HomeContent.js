...
var HomeContent = React.createClass({
  ...
  //   production.clicked = true;
  //   this.rowHasRead(production);
  //   this.props.navigator.push({
  //     name: 'production'
  //   })
  // },
  // _renderRow: function (rowData: string, sectionID: number | string, rowID: number, highlightRow) {
  //   var rowHash = Math.abs(hashCode(rowData));
  //   var imgSource = {
  //     uri: PIC_URLS[rowHash % THUMB_URLS.length],
  //   };
  ...
  //       key={rowData.id}
  //       onPress={this.selectProduction}>
  //       <Text
  //       style={this.props.nav.selected ? styles.navSelected: styles.navNormal}>
  //       numberOfLines={1}>
  ...
  //       <TouchableElement
  //       ref='touchableElement'
  //       onPress={this.selectNews}>
  //       <Image style={styles.pic} source={imgSource}/>
  //       </TouchableElement>
  //     );
  //     break;
  //   }
  ...
  //     color: 'rgb(41, 78, 189)'
  //   }, ['color']);
  //   this.refs['touchableElement'].setNativeProps(nativeProps); // 设置被点击的元素的效果
  // },
  // _renderSectionHeader: function (sectionData: object, sectionID: number | string) {
  //   switch (sectionName) {
  //     case 'production':
  //     return (
  //       <Text style={styles.sectionHeader} style={styles.productionHeader}>
  //       产品
  //       </Text>
  //     );
  //     break;
  //     case 'dynamic':
  //     return (
  //       <Text style={styles.sectionHeader} style={styles.dynamicHeader}>
  //       动态
  //       </Text>
  //     );
  //     break;
